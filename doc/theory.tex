...
\begin{equation*}
  ...
  \begin{aligned}[t]
    ...
    \bnfor {}& \cmdEq{\expr}{\cmd}           &&\text{equality type} \\
...
\begin{mathpar}
  ...
  {\evali \ctxenv \expr {\e_1} {\T_1} \\
    \evali \ctxenv \cmd {\e_2} {\T_2} \\
    \eqtypealg \ctxenv {\T_1} {\T_2}}
  {\evali \ctxenv {\cmdEq \expr \cmd} {\JuEqual {\T_1} {\e_1} {\e_2}} \Type}
