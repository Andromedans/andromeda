...
\begin{mathpar}
  ...
  {\tywhnfs \ctxenv \T {\Prod \x {\T_1} {\T_2}} \\
    \evalc {\ctxextend \ctxenv \x {\T_1}} \cmd {\T_2} \e}
  {\evalc \ctxenv {\cmdLamCurry \x \cmd} \T {\lam \x {\T_1} {\T_2} \e}}

  \infer[\rulename{infer-$\lambda$}]
  {\evalc \ctxenv \expr \Type {\U_1} \\
    \evali {\ctxextend \G \x {\U_1} \envextend \x } \cmd \e {\U_2}}
