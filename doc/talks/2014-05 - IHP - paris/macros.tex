...
\newcommand{\PrEqual}[3]{\mathsf{Paths}_{#1}(#2,#3)} % Path type
\newcommand{\JuEqual}[3]{\mathsf{Id}_{#1}(#2,#3)} % Equality type

\newcommand{\PrElim}[6]{\mathsf{J}_{#1}(#2, #3, #4, #5, #6)} % Path eliminator
\newcommand{\JuElim}[6]{\mathsf{G}_{#1}(#2, #3, #4, #5, #6)} % Equality eliminator
...
\newcommand{\nPrEqual}[4]{\mathsf{paths}^{#1}_{#2}(#3,#4)} % Path type name
\newcommand{\nJuEqual}[4]{\mathsf{id}^{#1}_{#2}(#3,#4)} % Strict type name
