...
\newcommand{\lamS}[1]{\lambda #1 \,.\,} % $\lambda$-abstraction without type annotation
...
\newcommand{\JuElim}[4]{\mathsf{G}_{#1}(#2, #3, #4)} % Judgmental equality eliminator
\newcommand{\PrElimS}[3]{\mathsf{J}(#1, #2, #3)} % Synthesizing propositional equality eliminator
\newcommand{\JuElimS}[3]{\mathsf{G}(#1, #2, #3)} % Synthesizing propositional equality eliminator
...
\begin{equation*}
  ...
  \begin{aligned}[t]
    ...
    \bnfor {}&  \JuElim{\T}{\abst{x\,y\,p}{\U}}{\abst{z}{\e_1}}{\e_2}  &&\text{equality eliminator} \\
...
\begin{equation*}
  ...
  \begin{aligned}[t]
    ...
    \bnfor {}&  \lamS{\x} \e  &&\text{checking $\lambda$-abstraction} \\
    \bnfor {}&  \app{\e_1}{\e_2}  &&\text{application} \\
    \bnfor {}&  \unitTerm  &&\text{the element of unit type} \\
    \bnfor {}&  \prRefl{\T}{\e}  &&\text{identity path} \\
    \bnfor {}&  \PrElimS{\e_1}{\abst{x\,y\,p}{\U}}{\abst{z}{\e_2}}  &&\text{path eliminator} \\
    \bnfor {}&  \juRefl{\T} \e  &&\text{reflexivity} \\
    \bnfor {}&  \JuElimS{\e_1}{\abst{x\,y\,p}{\U}}{\abst{z}{\e_2}}  &&\text{equality eliminator} \\
...
\begin{mathpar}
  ...
  \infer[\rulename{check-abs}]
  { \chkterm{\ctxextend{\G}{\x}{\T} ; \H}{\e}{\U} }
  { \chkterm{\GH}{(\lamS{\x} \e)}{\Prod{\x}{\T} \U} }
...
\begin{mathpar}
  ...
  { \synterm{\GH}{\e_1}{\JuEqual{\T}{\e_3}{\e_4}}
    \\
    \istypealg{\GH}{\T}
    \\
    \istypealg{
...
\begin{mathpar}
  ...
  \infer[\rulename{norm-app-beta-1}]
  ...
  \infer[\rulename{norm-app-beta-2}]
  { \whnf{\GH}{\subst{\e_1}{\x}{\e_2}}{\e_3} }
  { \whnf
    {\H}
    {\app{(\lamS{\x} \e_1)}{\e_2}}
