...
\noindent
Congruence rules for equality types:
%
\begin{mathpar}
...
\infer[\rulename{eq-name-universe}]
{\isctx{\G} \\
  \alpha = \beta \\
  \uClose{\alpha} = \gamma
}
