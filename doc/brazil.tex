...
\newcommand{\eqtermalg}[4]{#1 \vdash #2 \thickapprox #3 \Leftarrow #4} % equal terms
\newcommand{\eqtermext}[4]{#1 \vdash #2 \simeq #3 \Leftarrow #4} % equal nomral-form terms
\newcommand{\eqpath}[4]{#1 \vdash #2 \thicksim #3 \Rightarrow #4} % equal terms

\newcommand{\hintin}[1]{\mathsf{hint}\; #1 \; \mathsf{in} \;} % use hint
...
\noindent
Functoriality of coercions:
%
\begin{mathpar}
\infer[\rulename{eq-name-coerce-refl}]
  {\isterm{\G}{\e}{\Universe{\alpha}}}
  {\eqterm{\G}{(\coerce{\alpha}{\alpha}{\e})}{e}{\Universe{\alpha}}}
...
\begin{mathpar}
  ...
  \infer[\rulename{tychk-el}]/JuEqual
...
\begin{mathpar}
  ...
  \infer[\rulename{norm-coerce-refl}]
  {
  }
  {
    \whnf{\H}{(\coerce{\e}{\alpha}{\alpha})}{\e}
  }
  ...
  {
    \whnf{\H}{\coerce{(\coerce{\e}{\alpha}{\beta}}{\beta}{\gamma})}
             {\coerce{\e}{\alpha}{\gamma}}
           }

\end{mathpar}

Rule~\rulename{norm-G} is very general, being essentially a K rule.
...
In this last rule, we might want to check whether $\e'_1 = \e'_2$ before invoking the general
comparison function.
...
\begin{mathpar}
  ...
  \infer[\rulename{chk-eq-whnf-j}]
  {
   ...
   \eqtypealg{
    \ctxs{
     (\ctxextend{\ctxextend{\ctxextend{\G}{x}{\T}}{y}{\T}}{p}{\PrEqual{\T}{x}{y}})}{\H}}
    {P}{Q} \\\\
   \eqtermalg{\ctxs{(\ctxextend{\G}{z}{\T})}{\H}}{\e_1}{\e'_1}{\substs{P}{z/x, z/y, (\prRefl{\T}{z})/p}}
   \\\\
   \eqtermalg{\GH}{\e_2}{\e'_2}{T} \\
   \eqtermalg{\GH}{\e_3}{\e'_3}{T} \\
   \eqtermalg{\GH}{\e_4}{\e'_4}{\PrEqual{\T}{\e_2}{\e_3}}
  }
  {\eqpath
     {\GH}
     {\PrElim{\T}
...
\begin{mathpar}
  ...
  {\alpha = \beta\\
    \eqtermalg{\GH}{\e_{\T}}{\e_{\U}}{\Universe{\alpha}}\\
    \eqtermalg{\GH}{\e_1}{\e'_1}{\El{\alpha}{\e_{\T}}}\\
    \eqtermalg{\GH}{\e_2}{\e'_2}{\El{\alpha}{\e_{\T}}}
  }
  {\eqterm{\GH}{\nPrEqual{\alpha}{\e_T}{\e_1}{\e_2}}{\nPrEqual{\beta}{\e_U}{\e'_1}{\e'_2}}{\Universe{\alpha}}}
  ...
  {\eqtermalg{\GH}{\nJuEqual{\alpha}{\e_T}{\e_1}{\e_2}}{\nJuEqual{\beta}{\e_U}{\e'_1}{\e'_2}}{\Universe{\alpha}}}
  ...
  {
    \eqpath{\GH}{\coerce{\e_1}{\alpha}{\beta}}
                {\coerce{\e_2}{\gamma}{\delta}}
                {\Universe{\beta}}
  }
...
Right now we don't have rules for whnf equivalence of the unit value, or of $\lambda$-abstractions. In principle,
extensionality should get rid of these\ldots
\end{document}
