...
\begin{mathpar}
  ...
  {
    \tywhnf{\H}{\El{\alpha}{(\coerce{\beta}{\gamma}{\e}})}{\El{\alpha}{\e}}
  }
...
will give us $\whnf{\H}{\El{\zero}{\nUnit}}{\El{\zero}{\mathsf{nat}}}$. Only
if we were to backtrack (and we don't, in the current implementation) would we
consider $\whnf{\H}{\El{\zero}{\nUnit}}{\Unit}$.
...
We might want to have normalization accumulate these hints...especially equation hints, which are always harmless.
