...
\newcommand{\hintextend}[4]{#1, #2} % extended hint list
\newcommand{\GH}{\G ; \H}           % combined context and hints

% normalization

\newcommand{\whnf}[4]{#1 \vdash #2 \leadsto #3 : #4} % "normalization" at a type
...
\begin{mathpar}
  ...
  \infer[\rulename{htctx-extend-hint}]
  {\ishint{\G}{\H} \\
   \eqterm{\GH}{\e_1}{\e_2}{\T}
  }
...
\begin{mathpar}
  ...
  { \synterm{\GH}{\e_1}{\JuEqual{\U}{\e_3}{\e_4}} \\
    \synterm{\G ; \hintextend{\H}{\e_3}{\e_4}{\U}}{\e_2}{\T}
  }
  { \synterm{\GH}{(\hintin{\e_1} \e_2)}{\T} }

  \infer[\rulename{chk-hint}]
  { \synterm{\GH}{\e_1}{\JuEqual{\U}{\e_3}{\e_4}} \\
    \chkterm{\G ; \hintextend{\H}{\e_3}{\e_4}{\U}}{\e_2}{\T}
  }
...
\begin{mathpar}
  ...
  { \whnf{\GH}{\e}{(\lam{\x}{\U}{\e'})}{\T} }

  \infer[\rulename{norm-hint-idpath}]
  { \ishint{\G}{\H} \\
    \eqtermhint{\e}{\prRefl{\U}{\e'}}{\T} \in \H
  }
  { \whnf{\GH}{\e}{\prRefl{\U}{\e'}}{\T} }

  \infer[\rulename{norm-hint-refl}]
  { \ishint{\G}{\H} \\
    \eqtermhint{\e}{\juRefl{\U}{\e'}}{\T} \in \H
  }
  { \whnf{\GH}{\e}{\juRefl{\U}{\e'}}{\T} }
\end{mathpar}
%
