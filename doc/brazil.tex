...
%
\begin{equation*}
  \mathcal{F}_0 \subseteq
  \mathcal{U}_0 \subseteq
  \mathcal{F}_1 \subseteq
  \mathcal{U}_1 \subseteq
  \cdots
\end{equation*}
%
...
In this section we give the formulation of Brazilian type theory in a declarative way
...
\begin{mathpar}
  ...
  \infer[\rulename{norm-el-universe}]
  { \norm{\e}{\nUniverse{\alpha}}
  }
  { \tynorm
    {\El{\alpha}{\e}}
...
\begin{mathpar}
  ...
  { 
    \norm
    {\coerce{\alpha}{\alpha}{\e}}
    {\e'}
  }

  \infer[\rulename{norm-coerce-trans}]
  {
    \norm{\e}{\coerce{\alpha}{\beta}{\e'}} \\
    \norm{\coerce{\alpha}{\gamma}{\e'}}{\e''}
  }
  { 
    \norm
    {\coerce{\beta}{\gamma}{\e}}
  ...
  \infer[\rulename{norm-coerce-pi}]
  {
    ...
    \alpha \leq \gamma \\
    \beta \leq \gamma \\\\
    \norm{\coerce{\alpha}{\delta}{\e_1}}{\e_1'} \\
    \norm{\coerce{\beta}{\delta}{\e_2}}{\e_2'}
  }
  { 
    \norm
    {\coerce{\gamma}{\delta}{\e}}
    {\nProd{\delta}{\delta}{\x}{\e_1'}{\e_2'}}
  }
