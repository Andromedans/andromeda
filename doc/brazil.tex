...
\begin{mathpar}
  ...
  {\eqtype{\G}{\T_1}{\U_1}\\
    \eqterm{\ctxextend{\G}{\x}{\T_1}}{\T_2}{\U_2}\\
  ...
  {\eqterm{\G}{(\app{\e_1}{\x}{\T_1}{\T_2}{\e_2})}{(\app{\e'_1}{\x}{\U_1}{\U_2}{\e'_2})}{\subst{\U_2}{\x}{\e_2}}}
\end{mathpar}

Under this rule, it seems possible for the identical-except-for-annotations terms $(\app{\e_1}{\x}{\T_1}{\T_2}{\e_2})$ and
$(\app{\e_1}{\x}{\U_1}{\U_2}{\e_2})$ to be \emph{not} equivalent, because we cannot necessarily guarantee that $ \eqtype{\ctxextend{\G}{\x}{\T_1}}{\T_2}{\U_2}$. That seems unfortunate.  Could we safely relax this premises?
...
\infer[\rulename{eq-beta}]
  {\eqtype{\G}{\T_1}{\U_1}\\
    ...
    \isterm{\G}{\e_2}{\T}}
  {\eqterm{\G}{\app{(\lam{\x}{\T_1}{\T_2}{\e_1})}{\x}{\U_1}{\U_2}{\e_2}}
              {\subst{\e_1}{\x}{\e_2}}
              {\subst{\T_2}{\x}{\e_2}}}
