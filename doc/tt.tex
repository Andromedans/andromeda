...
\begin{mathpar}
  ...
  \infer[eval-handle-op]
  {
    ...
    \\\\
    \cont' = \bigl(\withhandle{\h}{\letin{\X' = \hole} \letin{\X'' = \ascribe{\X'}{\T}}{\kapp{cont_\D}{\X''}}}\bigr)\\
    \\\\
    \h = \typicalhandler
    \\\\
    \evalto[\G,\D]
...
\begin{mathpar}
  ...
  {
    \h = \typicalhandler\\
    \cont' = \bigl(\withhandle{\h}{\letin{\X' = \hole} \letin{\X'' = \ascribe{\X'}{\T}}{\kapp{\hfcont_\D}{\X''}}}\bigr)\\
    \evalto[(\G,\D);\S]{\substs{\C_2}{\T/\X, \cont'/\K}}{\e}\\
    \eok[\G]{\e}
  }
  {
    \evalto[\G;(\S,\h)]
    {{\hfcont_\D}[\inhabitOp{\T}]}
    {\e}
  }
