...
\begin{mathpar}
  ...
  \infer[eval-handle-op]
  {
    ...
    \\\\
    \evalto[\G,\D]
    {\substs{\C_2}{\T/\X, (\withhandle{h}{\cont})/\K}}
    {R}
    \\\\
    \resultok{R}\\
  }
...
Also, here or somewhere we need to check that the result of an inhabit operation is a Brazil term of the correct type. That checking might invoke handlers, if we're not careful\ldots
