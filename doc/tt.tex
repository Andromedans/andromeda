...
\begin{mathpar}
  ...
  {\evalto{\begin{array}[t]{l}
             ...
             \qquad \letin{\X_2 = \eqtermalgOp{\e_1}{\T}{\e'_1}{\T}{\T}}\\
             \qqquad \letin{\X_3 = \eqtermalgOp{\e_2}{\T}{\e'_2}{\T}{\T}}\\
...
\begin{mathpar}
  ...
  \infer[\rulename{chk-eq-whnf-j}]
  {
   ...
   \eqtermalg[\ws_3]
     ...
     \\
   \eqtermalg[\ws_4]{\GH}{\B_3}{\B'_3}{\T}\\
   \eqtermalg[\ws_5]{\GH}{\B_4}{\B'_4}{\T}\\
   \eqpath[\ws_6]{\GH}{\B_2}{\B'_2}{\PrEqual{\T}{\B_3}{\B_4}}\\
