...
\begin{mathpar}
  ...
  {\ctx \ent A : \Type \\
   ...
   \ctx \ent e_2 : A}
   {\ctx \ent \app[\abs{x : A} B]{e_1}{e_2} : \subst{x}{e_2}{B}}
\end{mathpar}
...
\begin{mathpar}
  ...
  % \infer[eq-subst]
  % {\ctx \ent \subst{x}{e_1}{e} : \subst{x}{e_1}{B} \\
  %  \ctx \ent e_1 = e_2 : A}
  % {\ctx \ent \subst{x}{e_2}{e} : \subst{x}{e_2}{B}}

  \infer[eq-reflexivity]
  {\ctx \ent e : A}
  {\ctx \ent e = e : A}
