...
\begin{frame}
  ...
  \note[item]{We are also working on an extension of Brazil, called ``tt''. This is a more
    ambituous piece of work. You can think of it as a special-purpose programming language
  ...
  \note[item]{As tt is more experimental than Brazil, I will focus on Brazil and discuss
    tt only brieflt at the end. But please talk to Chris and me, and we'll show you both
...
\begin{frame}
  ...
  \note[item]{Next, equality checking is done by an adaptation of an algorithm developed
    by Bob Harper and Chris Stone. The original algorithm is augmented with a
    \emph{database of equality hints} which it consults whenever it gets stuck.}
...
\begin{frame}
  ...
  \note[item]{Finally, let me say a few words about TT.}
\end{frame}
