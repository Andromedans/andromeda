...
val instantiate : int * Syntax.ty * Syntax.term * Syntax.term -> Syntax.ty -> Syntax.term -> Syntax.term -> bool

(** Instantiate as a rewrite rule.  Assumes all inputs are normalized. *)
val rewrite : int * Syntax.ty * Syntax.term * Syntax.term -> Syntax.ty -> Syntax.term -> Syntax.term option
