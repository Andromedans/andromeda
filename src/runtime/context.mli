...
val lookup_free : Name.t -> t -> Value.ty option

(** Lookup a free variable by its de Bruijn index *)
val lookup_bound : Syntax.bound -> t -> Name.t * Value.ty
...
val add_free : Name.t -> Value.ty -> t -> t 
...
val add_fresh : Name.t -> Value.ty -> t -> Name.t * t
