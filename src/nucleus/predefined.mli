(* This is a plug because someone forgot to add predefined.ml *)

val mk_list : Runtime.value list -> Runtime.value

val as_list : loc:Location.t -> Runtime.value -> Runtime.value list

val from_constrain : ('a, 'b) Tt.constrain -> Runtime.value

val as_constrain : loc:Location.t -> Runtime.value -> ('a, 'b) Tt.constrain
