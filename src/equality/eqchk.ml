...
and prove_eq_term ~ext chk sgn bdry =
  let normalization_phase bdry =
     ...
     let e1_eq_e1', Normal e1' = Eqchk_normalizer.normalize_term ~strong:false sgn chk.normalizer e1
     and e2_eq_e2', Normal e2' = Eqchk_normalizer.normalize_term ~strong:false sgn chk.normalizer e2 in
